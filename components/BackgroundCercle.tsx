...
function BackgroundCercle({}: Props) {
  return (
    <motion.div
    initial={{
        opacity: 0,
    ...
    <div className=' border border-[#F7AB0A] rounded-full opacity-20  h-[800px] w-[800px] mt-52 animate-pulse absolute'></div>
    </motion.div>
  )
}

export default BackgroundCercle